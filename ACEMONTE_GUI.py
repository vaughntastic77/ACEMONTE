...
class Run_Section:
    def __init__(self, master, title,xvar,yvars):
        ...
        self.y_variables.insert('1.0',yvars)
    ...
    def set_default_text(self, Text, default_text):
...
def launch(xvar = 'P01', yvars = 'Re(P)'):
    ...
    run_section = Run_Section(root, "RunData",xvar,yvars)
